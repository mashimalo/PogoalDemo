        ...
        <li class="uiFeed__reply__item">
            ...
            <div class="uiFeed__misc">
                <div class="pull-left forms--inline">
                    ...
                    {{--{!! Form::model($comment, ['route'=> ['comment-like-dockingGroup', 'dockingGroup_id' => $dockingGroup->id, 'comment_id' => $comment->id], 'method'=>'POST','id'=>'like-comment-dockingGroup', 'role'=>'form'])!!}--}}
                    ...
                    {{--{!! Form::model($comment, ['route'=> ['comment-unlike-dockingGroup', 'dockingGroup_id' => $dockingGroup->id, 'comment_id' => $comment->id], 'method'=>'POST','id'=>'unlike-comment-dockingGroup', 'role'=>'form'])!!}--}}
                    {{--<button class="btn btn-sns">--}}
                    {{--<span class="icon icon-thumb-down"></span>--}}
                    {{--<span class="btn-sns__count">{{ $comment->unlikes->count() }}</span>--}}
                    {{--</button>--}}
            ...
            ----------------------------}}
            @include('templates.docking.feed.backup.dockingGroupPage-feed-childReply')
