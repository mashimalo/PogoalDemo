...
return [
    ...
    'dockingRequestSend'                 => 'Your bridging group request has been send.',
    'dockingRequestHasAlreadySend'       => 'Your request has sent, please wait for other group\'s admin accept your request.',
    'targetGroupAlreadyDocking'          => 'Your group has already bridged with the target group.',
    'groupHaveAlreadySendDockingRequest' => 'That group has already send you the bridging group request, please accept the request.',
    'dockingAccepted'                    => 'You have accept a bridging group request.',
    'dockingDeny'                        => 'You have deny a bridging group request.',
    'feedNotFound'                       => 'Feed Not Found.',
    'feedInPrivateGroup'                 => 'The feed is in a private group.',
    'feedInPrivateDockingGroup'          => 'The feed is in a private bridged group.',
];